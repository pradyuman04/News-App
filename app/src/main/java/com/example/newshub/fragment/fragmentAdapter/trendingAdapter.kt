package com.example.newshub.fragment.fragmentAdapter
...
class trendingAdapter(val activity: FragmentActivity?, val list: List<ArticlesItem2>) : RecyclerView.Adapter<trendingAdapter.ViewData>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewData {
        var view = LayoutInflater.from(activity).inflate(R.layout.trending_item,parent,false)
    ...
    override fun onBindViewHolder(holder: ViewData, position: Int) {
        ...
        holder.titleTxt.setOnClickListener {
            ...
            intent.putExtra("n2",list[position].author)
