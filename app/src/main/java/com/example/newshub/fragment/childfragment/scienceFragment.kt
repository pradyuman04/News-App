...
import com.example.newshub.databinding.ScienceFragmentBinding
import com.example.newshub.fragment.childfragment.childFrafmentAdapter.ScienceAdpater
...
class scienceFragment : Fragment() {
    ...
    lateinit var binding: ScienceFragmentBinding
    ...
    fun loaddata(list: List<ArticlesItem2>) {
        ...
        var adapter = ScienceAdpater(activity,list)
        var layoutManager = LinearLayoutManager(activity)
        binding.scienceRecyclerView.adapter = adapter
        binding.scienceRecyclerView.layoutManager = layoutManager
